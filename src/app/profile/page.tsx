      ...
      <div className="relative z-10 min-h-screen pt-16 sm:pt-20 p-3 sm:p-4 md:p-6">
        ...
        <header className="text-center mb-6 sm:mb-8 md:mb-12 pt-4 sm:pt-6 md:pt-8">
          <div className="inline-flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <User className="w-5 h-5 sm:w-6 md:w-8 sm:h-6 md:h-8 text-blue-600 animate-pulse" />
        ...
        <div className="max-w-4xl mx-auto">
          <FloatingPanel title="User Dashboard" glowColor="blue" className="h-[600px] sm:h-[700px]">
            <UserDashboard />
          </FloatingPanel>
        </div>
